...
!   This computes the Poisson phi function, as described in paper 
...
!             polynomial, and the full output polynomial has degree 2*n-2.
!     kd    Denominator of rational arguments of phi_2; default = 30.
...
!     lmx   ***Must be > length in characters of full relation in Mathematica
!             format; default = 131072.  
...
integer ipal, kd, kp, kq, lcx, lmx, mpi
parameter (ipal = 1, kd = 30, kp = 1, kq = 1, lcx = 64, lmx = 131072, mpi = 8)
integer idb, n, ndp, ndpm, ndr, nep, nepm, nrb, nwds, nwdsm
parameter (idb = 2, n = 33, ndp = 1100, ndpm = 160, ndr = 20, nep = 30 - ndp, &
  nepm = 20 - ndpm, nrb = 200, nwds = int (ndp / mpdpw + 2), &
  nwdsm = int (ndpm / mpdpw + 2))

integer i, iq, i1, i2, j, j1, k, l1, m, n1
real (8) d1, d2, second, tm, tm0, tm1, tm2, tm3
external second
type (mp_real) al, beta, eps, epsm, pi, qq, xx, yy
