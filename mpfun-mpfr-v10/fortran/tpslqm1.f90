...
!             degree; default for this program (when kq = 0) = kr * ks + 1 = 31.
!     ndp   Full precision level in digits; default for this program = 240.
...
parameter (itr = 1, kq = 0, kr = 5, ks = 6, lcx = 64)
integer idb, n, ndp, ndr, nep, nrb, nwds
parameter (idb = 2, n = kr * ks + 1, ndp = 240, ndr = 20, &
  nep = 20 - ndp, nrb = 200, nwds = int (ndp / mpdpw + 2))

real (8) d1, d2, m, second, tm, tm0, tm1
...
write (6, 1) itr, n, kq, kr, ks, ndr, nrb, ndp, nep
...
!   Perform relation search.
  ...
  tm0 = second ()
  call pslqm1 (idb, n, nwds, ndr, nrb, eps, x, iq, r)
  tm1 = second ()
...
subroutine pslqm1 (idb, n, nwds, ndr, nrb, eps, x, iq, r)
...
!     itm   int*4   Maximum iteration count; default = 10^5. Run will be aborted
!                   if this is exceeded.
!     nsq   int*4   Size of tables used in iterdp and itermpw; default = 8.

use mpmodule
implicit none
integer i, idb, imq, ipi, ipm, iq, it, itm, izm, j, j1, n, ndr, nrb, &
  nwds, nsq, n1, n2, n3, n4
parameter (ipi = 25, ipm = 100, itm = 100000, nsq = 8)
real (8) d1, d2, d3, d4, dplog10, second, tm0, tm1, times(2)
real (8) dx(n)
...
6     format ('Iteration',i8,2x,'Norm bound =',f11.6,'e',i5,4x,'Max. bound =', &
        f11.6,'e',i5)
    endif
